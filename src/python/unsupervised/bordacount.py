...
Authors: fsw, Tancilon
Date: 20231016
Define the input format to the algorithm as a CSV file: Query | Voter name | Item Code | Item Rank
...
def bordacount(input_file_path, output_file_path):
    ...
    for query in unique_queries:
        ...
        # Create reverse mappings from integer to string
        ...
        # Generate mappings from string to integer
        ...
        # Create a 2D Numpy array for Voter Name * Item Code, initialized with NaN
